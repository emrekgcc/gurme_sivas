...
function restoranlariGoster(liste) {
    // 1. ADIM: DOM yormamak için koca bir string oluşturuyoruz
    let htmlContent = ""; 
    ...
    siraliListe.forEach((restoran) => {
        ...
        // 2. ADIM: CLS ENGELLEME - Resimlere net boyut verdik (width/height)
        // loading="lazy" ile ekran dışındakileri sonra yükletiyoruz
        htmlContent += `
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn-kesfet" 
                            aria-label="${restoran.ad} detaylarını keşfet" 
                            onclick="window.location.href='detay.html?id=${orijinalIndex}'">
                        KEŞFET
                    </button>
                </div>
    ...
    // 3. ADIM: Tek seferde DOM'a basıyoruz (Hızın sırrı burada!)
