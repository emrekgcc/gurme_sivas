// Zorunlu yeniden düzenleme (Forced Reflow) YOK:
// - innerHTML += döngüsü YOK
// - offsetWidth / offsetHeight sorgusu YOK
// - Tüm HTML tek seferde DOM'a basılıyor (Batch Update)

const grid = document.getElementById('restaurant-grid');
const filterBtns = document.querySelectorAll('.filter-btn');

// O(1) index erişimi — döngü içinde indexOf yok
...
function restoranlariGoster(liste) {
    ...
    // Tüm HTML string'de biriktirilir, DOM'a tek seferde basılır
    let htmlContent = "";
    ...
    siraliListe.forEach((restoran, index) => {
        ...
        // İlk 3 kart LCP için eager, geri kalanlar lazy
