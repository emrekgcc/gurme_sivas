// Sayfa alt bilgilerini ve sosyal medya linklerini dinamik olarak yönettiğimiz alan.
function loadFooter() {
    const footerHTML = `
...
// Script asenkron (defer) olarak çalıştığı için DOM'un durumunu kontrol ederek footer'ı ekliyoruz.
